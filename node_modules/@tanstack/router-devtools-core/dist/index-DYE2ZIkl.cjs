  ...
  mount(el) {
    ...
    const dispose2 = render(() => {
      ...
      if (this.#Component) {
        ...
        Devtools = lazy(() => Promise.resolve().then(() => require("./FloatingTanStackRouterDevtools-Oh23ljuQ.cjs")));
  ...
  mount(el) {
    ...
    const dispose2 = render(() => {
      ...
      if (this.#Component) {
        ...
        BaseTanStackRouterDevtoolsPanel = lazy(() => Promise.resolve().then(() => require("./BaseTanStackRouterDevtoolsPanel-CSLuWlgG.cjs")).then((n) => n.BaseTanStackRouterDevtoolsPanel$1));
...
//# sourceMappingURL=index-DYE2ZIkl.cjs.map
